...
- Phase 2 of the download overhaul has been completed, with a new installer added for easier downloading and running of the app.

Bug Fixes

- Misleading colour save fallback messages have been fixed.
- Grammatical errors in the dynamic changelog text have been fixed.
""")
