...
• Minor cosmetic fixes throughout the app.
...
• Phase 2 of the UX overhaul, adding more shorthands for the directory - it's tricky to use right now.
...
|_   _|__ _ __ _ __ ___  _   ___  __ __   _/ | |___ \  / |
  | |/ _ \ '__| '_ ` _ \| | | \ \/ / \ \ / / |   __) | | |
  | |  __/ |  | | | | | | |_| |>  <   \ V /| |_ / __/ _| |
  |_|\___|_|  |_| |_| |_|\__, /_/\_\   \_(_)_(_)_____(_)_|
